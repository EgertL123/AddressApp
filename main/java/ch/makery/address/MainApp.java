...
import ch.makery.address.view.YearsStatisticsController;
...
public class MainApp extends Application {
    ...
    /**
     * Shows the statistics view inside the root layout.
     */
    public void showStatistics() {
        try {
            // Load statistics view.
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(MainApp.class.getResource("view/YearsStatistics.fxml"));
            AnchorPane statisticsView = (AnchorPane) loader.load();

            // Set statistics view into the center of root layout.
            rootLayout.setCenter(statisticsView);

            // Give the controller access to the main app.
            YearsStatisticsController controller = loader.getController();
            controller.setMainApp(this);
        } catch (IOException e) {
            e.printStackTrace();
        }
